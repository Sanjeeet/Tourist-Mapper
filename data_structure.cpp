...
int DataStructure::courier_counter;
vector<DeliveryInfo> DataStructure::deliveries_vector; 
vector<unsigned> DataStructure::depot_vector;
vector<unsigned> DataStructure::pick_up_vector;
vector<unsigned> DataStructure::drop_off_vector;
unsigned DataStructure::id_of_pick_up;
vector <unsigned> DataStructure::draw_courier_path;


/********************************************* Defining for Milestone 4 ***************************************************/
vector <Vertex> DataStructure::vector_of_verticies;
vector <waveElem> DataStructure::int_id_to_waveElem;
unordered_map < unsigned, double > DataStructure::street_seg_trave_time;
vector < double > DataStructure::street_seg_to_street_segment_length;
unordered_map < unsigned, unordered_map < unsigned, vector <NewDeliveryInfo> > > DataStructure::deliveryInfos;
string DataStructure::which_map;

//unordered_map <unsigned, vector <unsigned>> DataStructure::pick_up_to_drop_off; 
//unordered_map <unsigned, vector<unsigned>> DataStructure::drop_off_to_pick_up; 
//
vector <unsigned> DataStructure::see_if_pick_up_or_drop_off;
vector <unsigned> DataStructure::backwards;

map <unsigned, unsigned > DataStructure::pick_up_look_up_table;
unordered_map <unsigned, unordered_map <unsigned, double> > DataStructure::time_matrix;
map <unsigned, unsigned> DataStructure::backwards_map;
