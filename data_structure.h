...
public:
    ...
    static int courier_counter;
    static vector<DeliveryInfo> deliveries_vector; 
    static vector<unsigned> depot_vector;
    static vector<unsigned> pick_up_vector;
    static vector<unsigned> drop_off_vector;
    static unsigned id_of_pick_up;
    static vector <unsigned> draw_courier_path;
    /**************************************************** Milestone 4 Data Structures *********************************************/
    static vector <Vertex> vector_of_verticies;
    static vector < waveElem> int_id_to_waveElem;
    static unordered_map < unsigned, double > street_seg_trave_time;
    static vector < double > street_seg_to_street_segment_length;
    static unordered_map < unsigned, unordered_map < unsigned, vector <NewDeliveryInfo> > > deliveryInfos;
    static string which_map;

//    unordered_map <unsigned, vector <unsigned>> pick_up_to_drop_off;
//    unordered_map <unsigned, vector <unsigned>> drop_off_to_pick_up;
    static vector <unsigned> see_if_pick_up_or_drop_off;
    static vector <unsigned> backwards; 

    //    static Graph graph;
    
    
    
    static map <unsigned, unsigned> pick_up_look_up_table;
    static unordered_map <unsigned, unordered_map <unsigned, double> > time_matrix;
    static map <unsigned, unsigned> backwards_map;
